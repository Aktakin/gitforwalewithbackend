...
-- ✅ FIXED: Policies for requests table (NO RECURSION)
-- Simple policies without subqueries to avoid infinite recursion
...
-- 
-- Key Improvements:
-- ✅ FIXED: Infinite recursion error in requests SELECT policy
